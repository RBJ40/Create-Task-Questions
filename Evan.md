...
Remember to cook chicken. The program makes a card that contains the input along with a button to remove it.
...
If the amount of items in ToDoItems in greater than 0,
